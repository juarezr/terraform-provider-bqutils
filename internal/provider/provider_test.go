		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.bqutils_routine_parser.test", "reference_id", "mydataset.list_partitions"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckNoResourceAttr("data.bqutils_routine_parser.test", "reference_id"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.bqutils_routine_parser.test", "dataset_id", "mydataset"),
					resource.TestCheckResourceAttr("data.bqutils_routine_parser.test", "reference_id", "mydataset.fn"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.bqutils_view_parser.test", "reference_id", "mydataset.my_simple_view"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.bqutils_view_parser.test", "dataset_id", "mydataset"),
					resource.TestCheckResourceAttr("data.bqutils_view_parser.test", "reference_id", "mydataset.v"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.bqutils_dependency_layering.test", "layered_references.0.reference_id", "mydataset1.fn_a"),
					...
					resource.TestCheckResourceAttr("data.bqutils_dependency_layering.test", "layered_references.1.reference_id", "mydataset1.fn_b"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckNoResourceAttr("data.bqutils_view_parser.test", "reference_id"),
				),
			},
		},
	})
